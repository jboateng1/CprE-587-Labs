...
)
{
	...
	*path = &p[si];						/* Return pointer to the next segment */
	...
	// MPD:: 10/31/2022
	// The max file path used to be capped at 8 + 3 (which tooootally makes sense)
	// Up that to 1021 + 3 because that should be enough
	// const UINT max_file_path_size = 1021;
